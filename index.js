...
const SERVERNPORT = 'https://ajafsnode.serveo.net'; /* 'ajafsnode.serveo.net'; */ // from: 'ajtestacct@yahoo.com',
...
aj.serve.app.post('/api/add-save', (req, res) => {
    aj.trace('/api/add-save[POST]: req.body')(req.body);
        ...
        for (let [KYCIndex, scc] of usrKYC.entries()) {
            if (req.body.encEmailID == scc.encEmailID && req.body.hshPW == scc.hshPW) {
                ...
                for (let [idx, l] of updateUsrAst.entries()) {
                    ...
                    if (req.body.ownerName == l.ownerName && l.id != 0) {
                        ...
                        for (let [idex, ul] of req.body.myUsrUpdateList.entries()) {
                            if (ul.id == l.id) {
                                ul.ownerName = req.body.myUsrUpdateList[0].ownerName.toUpperCase();
                                ul.ownerMobile = req.body.myUsrUpdateList[0].ownerMobile;
                                ul.ownerEmail = req.body.myUsrUpdateList[0].ownerEmail;
                                updateUsrAst[idx] = ul;
                ...
                if (req.body.ownerName == 'ADD NEW') {
                    req.body.myUsrUpdateList[0].ownerName = req.body.myUsrUpdateList[0].ownerName.toUpperCase();
